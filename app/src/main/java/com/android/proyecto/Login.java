...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SharedPrefManager.getInstance(Login.this).isLoggedIn()) {
            finish();
            startActivity(new Intent(Login.this, Departamentos.class));
            return;
        }
        ...
        findViewById(R.id.existente).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void userLogin() {
        ...
        if (TextUtils.isEmpty(username)) {
            editTextUsername.setError("Ingrese nombre de usuario");
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        finish();
                        startActivity(new Intent(getApplicationContext(), Departamentos.class));
                    } else {
