...
public class mapacatolica extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapacatolica);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng coordenadas = new LatLng(13.9823641, -89.719527);
        mMap.addMarker(new MarkerOptions().position(coordenadas).title("CATOLICA"));
