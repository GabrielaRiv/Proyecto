...
public class mapagavidia extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapagavidia);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng coordenadas = new LatLng(13.9925714, -89.5653718 );
        mMap.addMarker(new MarkerOptions().position(coordenadas).title("GAVIDIA"));
