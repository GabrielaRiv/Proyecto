...
public class mapauma extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapauma);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng coordenadas = new LatLng(13.722327, -89.7288301 );
        mMap.addMarker(new MarkerOptions().position(coordenadas).title("UNAB"));
