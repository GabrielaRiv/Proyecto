...
public class mapaunasa extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapaunasa);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng coordenadas = new LatLng(13.9764908, -89.5887088 );
        mMap.addMarker(new MarkerOptions().position(coordenadas).title("UNASA"));
