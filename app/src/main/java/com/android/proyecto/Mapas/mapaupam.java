...
public class mapaupam extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapaupam);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        LatLng coordenadas = new LatLng(13.9197149, -89.8493216 );
        mMap.addMarker(new MarkerOptions().position(coordenadas).title("UPAN"));
