...
public class ggavidia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("http://www.sda.heavywebdesign.com/android/gale/gavidia/gavidia.php");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.perfil:
                Intent intent1 = new Intent(ggavidia.this, Perfil.class);
                startActivity(intent1);
                break;

            case R.id.acerca:
                Intent intent2 = new Intent(ggavidia.this, Acercade.class);
