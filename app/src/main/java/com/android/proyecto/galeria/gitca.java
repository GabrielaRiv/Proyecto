...
public class gitca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("http://www.sda.heavywebdesign.com/android/gale/itca/itca.php");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.perfil:
                Intent intent1 = new Intent(gitca.this, Perfil.class);
                startActivity(intent1);
                break;

            case R.id.acerca:
                Intent intent2 = new Intent(gitca.this, Acercade.class);
