...
import com.android.proyecto.galeria.gitca;
...
public class itca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itca);

        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        mapa = (Button) findViewById(R.id.mapa);
        id = (TextView) findViewById(R.id.textViewIditca);
        name = (TextView) findViewById(R.id.nombreitca);
        mision = (TextView) findViewById(R.id.misionitca);
        vision = (TextView) findViewById(R.id.visionitca);
        carreras = (TextView) findViewById(R.id.carrerasitca);
        telefono = (TextView) findViewById(R.id.telefonoitca);
        direccion = (TextView) findViewById(R.id.direccionitca);
        ...
        mapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mapa = new Intent(itca.this, MapaActivity.class);
                Marcador m = MarcadoresSingleton.getInstance().getMarcador("ITCA");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.perfil:
                Intent intent = new Intent(itca.this, Perfil.class);
                startActivity(intent);
                break;

            case R.id.acerca:
                Intent intent1 = new Intent(itca.this, Acercade.class);
                startActivity(intent1);
                break;

            case R.id.galeria:
                Intent intent2 = new Intent(itca.this, gitca.class);
