...
import com.android.proyecto.Mapas.Mapa;
...
public class uso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitud = (TextView) findViewById(R.id.latituduso);
        longitud = (TextView) findViewById(R.id.longituduso);
       ...
       // mViewPager.setAdapter(mSectionsPagerAdapter);
        ...
        mapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent mapa = new Intent(uso.this, Mapa.class);
                startActivity(mapa);
            }
        });
    }
  ...
  /* public static class PlaceholderFragment extends Fragment {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return uso.PlaceholderFragment.newInstance(position + 1);
        }
